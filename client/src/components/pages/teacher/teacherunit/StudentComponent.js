...
const StudentComponent = (props) =>{
    ...
    if(props.students.content!==[]){
        studentContent= (
            ...
            <caption>Classroom Key: {props.classroomKey}</caption>
                <thead>
                <tr>
                <th scope="col"></th>
                ...
                <div className="student">
                    <form>
                        <div className="form-group">
                                ...
                                <input type="text" onChange={props.handleInputChange} className="form-control" id="newStudent" placeholder="Enter Name"/>
                        </div>
